            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover"  id="table">
                        ...
                        <tbody>
                            <?php if (!empty($emanual_logs)) : ?>
                                <?php foreach ($emanual_logs as $log) : ?>
                                    <tr>
                                        ...
                                        <td class="center">
                                            <button class="btn btn-danger">
                                                <a href="<?= base_url('admin/logs/emanual_view_details/'.$log['UR_Code']); ?>" style="color:white; text-decoration: none;">
                                                    View
                                                </a>
                                            </button>
                                        </td>
