...
<div class="row">
    <div class="col-md-12">
        <h2>Audit Calendar Events Logs</h2> <br/>
    </div>
</div>
<hr />
<div class="row">
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover"  id="table">
                        ...
                        <tbody>
                            <?php if (!empty($audit_calendar_logs)) : ?>
                                <?php foreach ($audit_calendar_logs as $log) : ?>
                                    <tr>
                                        ...
                                        <td class="center">
                                            <button class="btn btn-danger">
                                                <a href="<?= base_url('admin/logs/calendar_events_view_details/'.$log['UR_Code']); ?>" style="color:white; text-decoration: none;">
                                                    View
                                                </a>
                                            </button>
                                        </td>
