 ...
 * @property Office_model $Office_model
	...
	public function create()
	{
		...
		$this->form_validation->set_rules(
			...
			array(
				...
				'regex_match' => "• Must be at least 8 characters long • Must contain at least one uppercase letter • Must contain at least one number • Must contain at least one special character (@$!%*?&)"
			)
		);
